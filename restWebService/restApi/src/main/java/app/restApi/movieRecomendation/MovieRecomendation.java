...
import br.ufrn.mmgg.agendadorframework.service.impl.AgendadorService;
...
@Service
public class MovieRecomendation extends AgendadorService implements RecomendationInterface{
    private final ArrayList<MovieData> dados;
...
//                System.out.println(splitedLine[0]);
    ...
    public void aplicarLogica() {
        ...
        carregarDados(); // daqui a 1 hr ele atualizará os dados
    }
}
